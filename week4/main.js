...
//getElementById Function
    ...
    function getData(){
        ...
        for(var i=0, j=localStorage.length; i<j;i++) {
            ...
            getImage(obj.products[1], subUlList); 
            for( var a in obj) {
    ...
    //Get image for correct category being displayed
    function getImage(catName, subUlList) {
        var imageLi = createEle("li");
        subUlList.appendChild(imageLi);
        var newImg = createEle("img");
        var setSrc = newImg.setAttribute("src", "images/"+ catName +".png");
        imageLi.appendChild(newImg);
        newImg.style.border = "1px solid black";
        newImg.style.margin = "5px";
        newImg.style.padding = "1px";
    }
    ...
    function editItem() {
        ...
        if(prodDetails.fav[1] === "Yes") {
            getEle("fav").setAttribute("checked", "checked");
        }
